...
**TodoApp** 是一款专为 Windows 设计的桌面待办事项管理工具。基于 PyQt6 构建原生界面，SQLite 本地存储数据，无需网络。提供列表、日历、看板、统计四种核心视图，支持高/中/低优先级、自定义分类标签、系统托盘最小化、任务到期提醒和每日摘要。内置柔和的浅色与深色护眼主题，适合长时间办公使用。
